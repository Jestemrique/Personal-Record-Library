...
//     return (
//         <div>
//             <h2>{album.content?.album_title}</h2>
//             <p>{album.content?.album_band?.content?.band_name}</p>
//             <p>{album.content?.album_year}</p>
//             <p>{album.content?.album_format}</p>
...
//                         />
//                     )}
//                     <p>Published: {lastFmData.wiki?.published}</p>
//                     <p>{stripHtml(lastFmData.wiki?.summary)}</p>
...
// const API_KEY = "3ebc646d04e0c2cedf31689ef021aad8";
...
//                     resolve_relations: "album.album_band",
//                 });
//                 console.log("Fetched album data: ", res);
//                 const story = res.data.stories[0];
//                 setAlbum(story);


//                 //Fetching last.fm album info.
//                 const artistName = story.content?.album_band?.content?.band_name;
//                 const albumTitle = story.content?.album_title;
...
//                             artistName)}&album=${encodeURIComponent(albumTitle)}&format=json`
//                     );

//                     const data = await lastFmRes.json();
//                     console.log("Last.fm data:", data);
//                     setLastFmData(data.album); // aquí guardamos solo la parte útil
//                 }
//             } catch (err) {
//                 console.log(err);
//             }
